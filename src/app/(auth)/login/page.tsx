    ...
    <div className="rounded-2xl border border-brand-sage/10 bg-white/80 p-6 shadow-lg backdrop-blur-sm dark:border-brand-sage/20 dark:bg-brand-bark/40">
      ...
      <div className="mt-6 space-y-3">
        ...
        <button
          ...
          disabled={isLoading !== null}
          className="flex w-full items-center justify-center gap-3 rounded-xl bg-black px-4 py-3 text-sm font-medium text-white shadow-sm transition-all hover:bg-gray-900 hover:shadow-md disabled:cursor-not-allowed disabled:opacity-50"
        >
          {isLoading === "apple" ? (
